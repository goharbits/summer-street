...
class InventoryController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $data1='<img style="width:360px" src="data:image/png;base64,' . base64_encode($generator->getBarcode($data, $generator::TYPE_CODE_128)) . '">';


        return view('admin.inventory._show', compact('inventory','data1'));
    }
