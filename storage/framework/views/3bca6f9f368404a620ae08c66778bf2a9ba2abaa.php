									    ...
									    <p class="list-group-item-text">
									    	<?php echo e(get_formated_shipping_range_of($shipping), false); ?>
										  	...
										  	<span class="badge indent20">
										  		<?php echo e($shipping->rate > 0 ? get_formated_currency($shipping->rate, 2) : trans('app.free'), false); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bitsclansolution/summerstreet/resources/views/admin/shipping_zone/index.blade.php ENDPATH**/ ?>