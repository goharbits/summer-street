                ...
                <div class="footer__content-box-inner">
                  <div class="footer__content-box-logo">
                    <a href="{{ url('/') }}">
                      ...
                      @else
                      <img src="../../themes/default/assets/img/summer-street-logo.svg" alt="{{ trans('app.logo') }}" title="{{ trans('app.logo') }}" style="max-width: 90%; margin-bottom: 0px;" />
              ...
              <div class="footer__content-box">
                <div class="footer__content-box-inner">
                  ...
                  <div class="footer__content-box-links">
                    <!-- <ul>
                      <li>
                        <a href="javascript:void(0)" rel="nofollow">@lang('theme.nav.your_account')</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)" rel="nofollow">@lang('theme.nav.your_orders')</a>
                      </li>
                      ...
                      @endforeach
                      <li>
                        <a href="javascript:void(0)" target="_blank">@lang('theme.nav.blog')</a>
                      </li>
                    </ul> -->
                    <ul>
                      <li>
                ...
                <div class="footer__content-box-inner">
                  ...
                  <div class="footer__content-box-links">
                    <ul>
                      ...
                      @endforeach
                      <li>
                        <a href="javascript:void(0)" rel="nofollow">@lang('theme.nav.faq')</a>
                      </li>
                    </ul>
