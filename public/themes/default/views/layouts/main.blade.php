...
<head>
  ...
  <link href="{{ theme_asset_url('css/mina_style.css') }}" media="screen" rel="stylesheet">
  <link href="{{ theme_asset_url('css/shoaib_style.css') }}" media="screen" rel="stylesheet">
  <link href="{{ theme_asset_url('css/zunair_style.css') }}" media="screen" rel="stylesheet">
  ...
  {{-- <!--[if lt IE 9]>
    ...
    <![endif]--> --}}
    <link rel="icon" type="image/x-icon" href="{{ theme_asset_url('img/Fevi.svg') }}" sizes="16x16">
</head>
