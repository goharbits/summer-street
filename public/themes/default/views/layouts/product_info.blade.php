<div class="product-info">
  ...
  <div class="row mb-2 btn-product-info-cus">
    <div class="col-lg-5 col-12 nopadding-right">
    ...
    <div class="col-lg-7 col-12 nopadding-left">
      @if ('quickView.product' == Route::currentRouteName())
        <a href="{{ route('show.store', $item->shop->slug) }}" class="btn btn-link btn-items">
