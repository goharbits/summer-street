...
<script type="text/javascript">
  ...
  (function($, window, document) {
    ...
    function calculateOrderTotal() {
      ...
      $('#summary-total').removeClass('text-muted text-danger').html(getFormatedPrice(total));
    }

    function canNotDeliver() {
      $('#summary-shipping-cost, #summary-total').addClass('text-danger text-uppercase').html('{{ trans('theme.notify.cant_deliver') }}');
      $('#summary-shipping-carrier').text(' ');
