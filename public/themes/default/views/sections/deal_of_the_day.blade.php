          ...
          <div class="row">
            <div class="col-lg-8">
              <div class="best-deal__col">
                <div class="best-deal__header best-deal__header_custom">
                ...
                <div class="week-deal week-deal-custom">
                  <div class="week-deal__label">{{ trans('theme.hot') }}</div>
                  <div class="week-deal__inner">
                    <div class="weak-deal-arr">
                    <div class="week-deal__slider week-deal__slider_custom deal-slider">
                     ...
                     <div class="best-deal__arrow week-deal__arrow">
                      <ul>
                        <li><button class="left-arrow slider-arrow week-deal-left"><i class="fas fa-arrow-left"></i></button></li>
                        <li><button class="right-arrow slider-arrow week-deal-right"><i class="fas fa-arrow-right"></i></button></li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div class="week-deal__details">
                      <div class="week-deal__details-name">
                        ...
                        <a href="javascript:void(0)">{!! strip_tags($deal_of_the_day->title) !!}</a>
                      </div>
                      ...
                      <div class="week-deal-btns mt-4">
                        <!-- <a href="javascript:void(0)" data-link="{{ route('cart.addItem', $deal_of_the_day->slug) }}" class="sc-add-to-cart" tabindex="0"> -->
                          <a href="javascript:void(0)"  class="sc-add-to-cart" tabindex="0">
                          <!-- <i class="fal fa-shopping-cart"></i> -->
                          <img src="../../themes/default/assets/img/cart-icon-img.svg">
                          <span class="d-none d-sm-inline-block">{{ trans('Add to cart') }}</span>
                ...
                <div class="best-deal__header best-deal__header_custom">
                  <div class="sell-header">
                    ...
                    <div class="best-deal__arrow">
                      <ul>
                        <li><button class="left-arrow slider-arrow best-seller-left"><i class="fas fa-arrow-left"></i></button></li>
                        <li><button class="right-arrow slider-arrow best-seller-right"><i class="fas fa-arrow-right"></i></button></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="best-seller">
                  <div class="best-seller__slider best-seller-slider best-seller-slider-custom">
